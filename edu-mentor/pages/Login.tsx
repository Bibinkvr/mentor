    ...
    <div className="min-h-screen flex items-stretch">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-surface relative overflow-hidden items-center justify-center p-20">
        ...
        <div className="relative z-10 text-center">
          ...
          >
             <img src="https://picsum.photos/seed/login-visual/400/600" alt="Login" className="w-full h-full object-cover opacity-60" />
          </motion.div>
          <h2 className="text-4xl font-bold mb-4 tracking-tight"><span className="text-gold">Edu</span> Mentor</h2>
          <p className="text-text-secondary text-lg">Premium learning. Proven results.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-background">
        <div className="w-full max-w-md">
          <div className="mb-12">
            ...
            <p className="text-text-secondary">Sign in to your account to continue your journey.</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="#" className="text-xs text-gold hover:underline">Forgot Password?</Link>
              </div>
              <input 
                type="password" 
                className="bg-elevated border border-gold-border/30 rounded-xl px-4 py-4 text-sm focus:outline-none focus:border-gold transition-colors"
          ...
          <p className="mt-10 text-center text-text-secondary text-sm">
            Don't have an account? <Link to="/register" className="text-gold font-bold hover:underline">Sign up for free</Link>
          </p>
        </div>
      </div>
    </div>
